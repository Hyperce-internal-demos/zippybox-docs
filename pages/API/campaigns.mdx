...
A friendly name for your campaign that is only used within ZippyBox. It helps you properly distinguish one campaign from another. An example may be "Newsletter - May 2020".
...
> If you find that your campaigns do not send, please ensure you have configured scheduled tasks and queue workers as described in the [Additional Configuration](/configuration-and-setup#additional-configuration) section.